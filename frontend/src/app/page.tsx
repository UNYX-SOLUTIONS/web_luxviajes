        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12 text-center">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Descubre nuestros destinos más solicitados con experiencias
              inolvidables
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-linear-to-b from-purple-50 to-blue-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12 text-center">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Ofrecemos soluciones integrales para todos tus necesidades de
              viaje
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-linear-to-r from-purple-600 to-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto">
            Contáctanos hoy y déjanos crear la experiencia de viaje perfecta
            para ti
          </p>
