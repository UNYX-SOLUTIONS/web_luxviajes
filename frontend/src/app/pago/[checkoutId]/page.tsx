...
export default function DatafastPaymentPage({
  params,
}: {
  ...
  useEffect(() => {
    if (!scriptReady || !checkoutId) return;
  ...
  return (
    <>
      <Script
        src="https://eu-test.oppwa.com/v1/paymentWidgets.js?checkoutId=D9F6322C2B1589BF4A188E26A1CA1B4E.uat01-vm-tx04"
        strategy="afterInteractive"
        onLoad={() => setScriptReady(true)}
      />

      <main className="min-h-screen bg-neutral-50 flex items-start justify-center pt-20 px-4">
