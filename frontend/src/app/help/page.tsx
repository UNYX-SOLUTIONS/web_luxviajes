...
const helpTopics = [
  {
    ...
    description: 'Asesoria integral, validez de pasaportes y solicitudes de visa.',
    icon: '📄',
  },
  {
    title: 'Pagos y Facturacion',
    description: 'Gestion de facturas, estado de reembolsos y metodos de pago seguros.',
    icon: '💳',
  },
  {
    title: 'Cancelaciones y Cambios',
    description: 'Opciones de reserva flexible, reprogramacion de viajes y terminos de cancelacion.',
    icon: '🗓️',
  },
  {
    title: 'Programa de Lealtad',
    description: 'Beneficios para miembros, acumulacion de puntos y acceso a recompensas exclusivas.',
    icon: '⭐',
  },
  {
    title: 'Seguro de Viaje',
    description: 'Cobertura de polizas, proceso de reclamos y asistencia medica de emergencia.',
    icon: '🛡️',
  },
  {
    title: 'Guias de Destino',
    description: 'Informacion local, itinerarios curados y tesoros ocultos en todo el mundo.',
    icon: '🗺️',
  },
];
    ...
    <>
      <section className="bg-primary-50 py-14 md:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden rounded-3xl bg-linear-to-r from-primary-900 to-primary-700 p-8 md:p-12">
            <div className="pointer-events-none absolute inset-0 opacity-20">
              <div className="h-full w-full bg-[radial-gradient(circle_at_top_right,white_0%,transparent_40%)]" />
            </div>

            <div className="relative mx-auto max-w-3xl text-center text-white">
              <h1 className="text-4xl font-extrabold leading-tight md:text-6xl">Como podemos ayudarte hoy?</h1>
              ...
              <form className="mx-auto mt-8 max-w-2xl">
                <div className="flex items-center rounded-full bg-white px-4 py-3 shadow-lg ring-1 ring-primary-100">
                  <span className="mr-3 text-primary-700">🔎</span>
                  <input
                    type="text"
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {helpTopics.map((topic) => (
              <article key={topic.title} className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-primary-100">
                <div className="mb-4 inline-flex h-10 w-10 items-center justify-center rounded-full bg-primary-100 text-lg">
                  {topic.icon}
                </div>
      ...
      <section className="bg-primary-100 py-16 md:py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-center text-4xl font-bold text-neutral-900">Preguntas Frecuentes</h2>
            ...
            {faqs.map((faq, index) => (
              ...
              >
                <summary className="flex cursor-pointer list-none items-center justify-between px-5 py-4 text-left text-sm font-semibold text-neutral-900">
                  {faq.question}
                  <span className="text-primary-700 transition group-open:rotate-180">⌃</span>
                </summary>
                <p className="px-5 pb-5 text-sm leading-relaxed text-neutral-600">{faq.answer}</p>
              </details>
            ))}
          </div>
        </div>
      ...
      <section className="bg-primary-50 py-16 md:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-5xl font-bold text-neutral-900">Aun necesitas ayuda?</h2>
            <p className="mx-auto mt-3 max-w-2xl text-base text-neutral-600">
              Nuestro equipo de soporte esta disponible las 24 horas para asegurar que tu viaje sea impecable.
            </p>
          </div>

          <div className="mt-10 grid grid-cols-1 gap-5 md:grid-cols-3">
            <article className="rounded-2xl bg-primary-700 p-8 text-center text-white shadow-lg">
              <div className="mx-auto mb-4 inline-flex h-12 w-12 items-center justify-center rounded-full bg-primary-600 text-xl">
                💬
              </div>
              <h3 className="text-2xl font-bold">WhatsApp Directo</h3>
              <p className="mt-2 text-sm text-primary-100">Mensajeria instantanea con nuestros expertos locales.</p>
              <Link
            ...
            <article className="rounded-2xl bg-white p-8 text-center shadow-sm ring-1 ring-primary-100">
              <div className="mx-auto mb-4 inline-flex h-12 w-12 items-center justify-center rounded-full bg-primary-100 text-xl">
                📞
              </div>
              <h3 className="text-2xl font-bold text-neutral-900">Linea de Soporte 24/7</h3>
              <p className="mt-2 text-sm text-neutral-600">Llamanos en cualquier momento, desde cualquier lugar del mundo.</p>
              <Link
            ...
            <article className="rounded-2xl bg-white p-8 text-center shadow-sm ring-1 ring-primary-100">
              ...
              <h3 className="text-2xl font-bold text-neutral-900">Consulta por Email</h3>
              <p className="mt-2 text-sm text-neutral-600">Envianos una solicitud detallada y te responderemos en menos de 2 horas.</p>
              <Link
      ...
      <section className="bg-primary-700 py-6 text-center text-white">
        <p className="text-sm font-medium">🛡 Tranquilidad en cada paso de tu viaje.</p>
      </section>
    </>
  );
}
