...
import { DestinationCard, PackageCard, ServiceCard, StatsSection, PromotionsMap, ServicesDetailSection, AppointmentSection, CTASection } from '@/components/sections';
