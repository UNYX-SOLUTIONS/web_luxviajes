...
export default function RegisterPage() {
  ...
  const getPasswordStrengthScore = () => {
    ...
    if (score <= 2) return { text: "Débil", color: "text-red-500", bg: "bg-red-100" };
    if (score <= 3) return { text: "Media", color: "text-yellow-500", bg: "bg-yellow-100" };
    if (score <= 4) return { text: "Buena", color: "text-blue-500", bg: "bg-blue-100" };
                  ...
                  <div className="w-full h-1.5 bg-neutral-200 rounded-full overflow-hidden">
                    <div
                      className={`h-full rounded-full transition-all duration-300 ${
                        getPasswordStrengthScore().color.replace("text-", "bg-")
                      }`}
                      style={{
