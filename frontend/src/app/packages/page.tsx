...
const premiumPackages = [
  {
    ...
    days: '12 Dias',
    price: '4,250',
    image: 'https://images.unsplash.com/photo-1542051841857-5f90071e7989?w=900&h=1200&fit=crop',
  },
  {
    tag: 'Popular',
    ...
    days: '8 Dias',
    price: '5,800',
    image: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=900&h=1200&fit=crop',
  },
  {
    tag: 'Todo Incluido',
    ...
    days: '10 Dias',
    price: '2,900',
    image: 'https://images.unsplash.com/photo-1519046904884-53103b34b206?w=900&h=1200&fit=crop',
  },
  {
    tag: 'Seleccion del concierge',
    ...
    days: '15 Dias',
    price: '6,400',
    image: 'https://images.unsplash.com/photo-1528164344705-47542687000d?w=900&h=1200&fit=crop',
  },
];
...
const dreamDestinations = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1536098561742-ca998e48cbcc?w=900&h=600&fit=crop',
  },
  {
    title: 'Panama Low Cost',
    nights: '4 dias, 3 noches',
    season: 'Disponible de Julio a Noviembre',
    image: 'https://images.unsplash.com/photo-1467269204594-9661b134dd2b?w=900&h=600&fit=crop',
  },
  {
    title: 'Medellin Full Pack',
    nights: '4 dias, 3 noches',
    season: 'Disponible de Julio a Noviembre',
    image: 'https://images.unsplash.com/photo-1536421469767-80559bb6f5e1?w=900&h=600&fit=crop',
  },
  {
    title: 'Cartagena + Panama',
    nights: '7 dias, 6 noches',
    season: 'Disponible de Julio a Noviembre',
    image: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=900&h=600&fit=crop',
  },
];
...
const themeParks = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1503917988258-f87a78e3c995?w=900&h=600&fit=crop',
  },
  {
    title: 'Tokyo Adventure',
    subtitle: 'Parques en Japon',
    image: 'https://images.unsplash.com/photo-1493780474015-ba834fd0ce2f?w=900&h=600&fit=crop',
  },
];
  ...
  return (
    <>
      <section className="relative overflow-hidden bg-neutral-900">
        ...
        <div className="relative mx-auto max-w-7xl px-4 pb-14 pt-24 sm:px-6 lg:px-8 lg:pb-20 lg:pt-32">
          <div className="mx-auto max-w-3xl text-center text-white">
            <h1 className="text-4xl font-extrabold md:text-6xl">Explora el Mundo</h1>
            <p className="mx-auto mt-4 max-w-2xl text-base text-primary-100 md:text-lg">
              Experiencias internacionales disenadas por expertos para el viajero mas exigente.
            </p>
          </div>
      ...
      <section className="bg-neutral-50 py-16 md:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-8 flex items-end justify-between gap-4">
            <div>
              <h2 className="text-4xl font-bold text-primary-700">Paquetes Premium</h2>
            ...
            <div className="hidden items-center gap-2 md:flex">
              <button className="h-9 w-9 rounded-full border border-neutral-300 text-neutral-600 transition hover:border-primary-400 hover:text-primary-700">‹</button>
              <button className="h-9 w-9 rounded-full bg-primary-700 text-white transition hover:bg-primary-800">›</button>
            </div>
          </div>

          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {premiumPackages.map((item) => (
              <article key={item.title} className="overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-neutral-200">
                <div className="relative">
                  <img src={item.image} alt={item.title} className="h-64 w-full object-cover" />
                  <div className="absolute inset-0 bg-linear-to-t from-primary-950/80 via-primary-900/20 to-transparent" />
                  <span className="absolute left-3 top-3 rounded-full bg-tertiary-500/90 px-3 py-1 text-[10px] font-semibold uppercase tracking-wider text-tertiary-50">
                    {item.tag}
                  </span>
                  <div className="absolute bottom-3 left-3 right-3 text-white">
                    <p className="text-xs text-primary-100">{item.days}</p>
                ...
                <div className="flex items-center justify-between p-4">
                  <div>
                    <p className="text-[10px] uppercase tracking-wider text-neutral-500">Desde</p>
                    <p className="text-xl font-bold text-primary-700">${item.price} USD</p>
                  </div>
                  <button className="h-10 w-10 rounded-full bg-primary-50 text-xl text-primary-700 transition hover:bg-primary-100">→</button>
                </div>
              </article>
            ))}
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-7 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end">
            <div>
              ...
              <h2 className="mt-1 text-4xl font-bold text-primary-700">Top Destinos Sonados</h2>
            </div>
            <Link href="/contact" className="text-sm font-semibold text-primary-700 transition hover:text-primary-800">
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {dreamDestinations.map((item) => (
              <article key={item.title} className="overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-primary-100">
                ...
                <div className="p-4">
                  ...
                  <p className="mt-2 text-sm text-primary-700">● {item.nights}</p>
                  ...
                  <p className="mt-4 text-xs text-tertiary-700">{item.season}</p>
                  <button className="mt-4 w-full rounded-full bg-primary-700 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-primary-800">
                    Cotizar
                  </button>
                </div>
              </article>
      ...
      <section className="bg-white py-16 md:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-5xl font-bold text-neutral-900">Parques Tematicos</h2>

          <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-3">
            {themeParks.map((park) => (
              <article key={park.title} className="relative overflow-hidden rounded-2xl">
                <img src={park.image} alt={park.title} className="h-72 w-full object-cover" />
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden rounded-3xl bg-linear-to-r from-primary-800 to-primary-700 px-8 py-12 text-white shadow-xl">
            ...
            <div className="relative flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
              <div>
                <h3 className="text-5xl font-bold leading-none">Listo para cruzar fronteras?</h3>
                <p className="mt-4 max-w-2xl text-primary-100">
                  Nuestros asesores expertos estan listos para disenar el viaje de tus suenos. Consultoria personalizada y sin compromiso.
                </p>
              </div>
              <Link
      ...
      <section className="bg-primary-700 py-16 text-white">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-primary-100">
            Recibe ofertas privilegiadas y destinos secretos directamente en tu bandeja de entrada.
          </p>
